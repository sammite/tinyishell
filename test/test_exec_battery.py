"""Test battery for remote command execution and exit code verification."""
...
def test_exec_exit_codes(tshd_daemon, command, expected_exit):
    """Verify that remote commands return expected exit codes."""
    config = tshd_daemon
...
def test_exec_touch_side_effect(tshd_daemon):
    """Verify side effects of remote execution using touch and remote ls."""
    config = tshd_daemon
